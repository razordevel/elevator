...
public class EncoderFileTest {
    ...
    private static void write(long time, long a, long b, long speed, long encoderSpeed, boolean overspeed) {
    ...
    public void testFileInput() {
        ...
        for (int i = 0; i < valuesA.size(); i++) {
            ...
            write(time, a, b, speed, encoderSpeed, overspeed);
